...
const Information = () => {
    ...
    return (
        <TableContainer component={Paper} className="information">
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                    <TableRow className="deliveryInform">
                        <TableCell align="center" className="tableCell" width={120}>Product ID</TableCell>
                        <TableCell align="center" className="tableCell" width={180}>Buying Product</TableCell>
                        <TableCell align="center" className="tableCell" width={120}>Price</TableCell>
                        <TableCell align="center" className="tableCell" width={80}>Month</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {rows.map((row) => (
                        <TableRow key={row.id} className="delivery_Table">
                            ...
                            <TableCell align="center" className="tableCell">
                                <span className={`month ${row.month}`}>{row.month}</span>
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
